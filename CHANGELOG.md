...
## 0.19.0-dev
 ...
 - [#653](https://github.com/tag1consulting/goose/pull/653) compare current load test results against previously saved JSON reports to identify performance regressions and track improvements over time using `--baseline-file`
