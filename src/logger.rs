...
//! [`GooseDefault::RequestLog`](../enum.GooseDefault.html#variant.RequestLog) default
...
//! [`GooseDefault::TaskLog`](../enum.GooseDefault.html#variant.TaskLog) default
...
//! [`GooseDefault::DebugLog`](../enum.GooseDefault.html#variant.DebugLog) default
//! configuration option.
//!
