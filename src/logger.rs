...
//! [`GooseDefault::RequestLog`](../enum.GooseDefault.html#variant.RequestFile) default
//! configuration option. The format of the log is configured with the `--request-format`
//! command-line option, or the
//! [`GooseDefault::RequestFormat`](../enum.GooseDefault.html#variant.RequestFormat) default
...
//! [`GooseDefault::TaskLog`](../enum.GooseDefault.html#variant.TaskFile) default
//! configuration option. The format of the log is configured with the `--task-format`
//! command-line option, or the
//! [`GooseDefault::TaskFormat`](../enum.GooseDefault.html#variant.TaskFormat) default
//! configuration option.
//!
...
//! [`GooseDefault::DebugLog`](../enum.GooseDefault.html#variant.DebugFile) default
//! configuration option.
//!
